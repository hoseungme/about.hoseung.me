...
export const projects: IProject[] = [
  {
    ...
    description:
      "이건 저의 개인 블로그를 만드는 프로젝트에요. 글에 대한 각종 통계, 알람 서비스 등 블로그에 관련된 여러 기능을 직접 커스터마이징하고 싶어서 시작하게 되었답니다. 현재 프로젝트 진행중에 있어요.",
    activities: [
  ...
  },
  {
    ...
    description:
      "이건 지금 보고계시는 저의 개인 웹사이트 프로젝트에요. 형식적인 이력서 보단 부드러운 인터랙션이 포함된 깔끔한 소개 페이지로 스스로를 어필하고 싶어서 시작하게 되었답니다.",
    activities: [
