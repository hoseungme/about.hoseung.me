...
- **배운 점 & 어려웠던 점**
  ...
  - BDD 방식의 테스트코드를 작성해볼 수 있었습니다.
    ...
    - 유저 입장에서 나올 수 있는 유효한 시나리오들을 자세히 생각해볼 수 있고, 이는 실제 유저가 인터랙션하는 시나리오이기 때문에, 현재 테스트를 작성하고 있는 기능에 대해 잘 이해하고 있다면 예외 상황을 많이 줄일 수 있었습니다. 또한, 나중에 해당 기능을 처음 작업하는 개발자 입장에서도 테스트 코드를 참조하면 빠른 코드 이해에 큰 도움이 되었습니다.
...
- **배운 점 & 어려웠던 점**
  - 사이즈 매핑율과 정확도를 개선하기 위해서 많은 생각을 했던 것 같습니다.
