...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    name: "공시가격 정보를 한눈에. 공동주택 공시가격 API",
    duration: "2020.01 ~ 2020.03",
    description:
      "고등학교 2학년 겨울방학 때 주식회사 집토스에서 인턴으로 근무하며 진행했던 토이 프로젝트 입니다. 프론트엔드 개발에 JQuery를 사용했고, CI/CD 자동화 프로세스를 처음 구축해 보았습니다. 약 1300만개의 대용량 데이터를 다루었기 때문에, 쿼리 속도 개선을 위해 인덱싱을 하는 등 성능 개선에 노력을 많이 기울였습니다.",
    references: [],
    tags: ["Front-end", "Back-end"],
  },
  {
    img: dsmMarketImage,
    name: "빠르고 간편한 교내 중고거래. 프로젝트 대마장터",
