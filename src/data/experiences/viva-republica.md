...
- 즉, 개발자 경험과 유저 경험 모두에 영향이 있는 상황이었기에, 바로 [타임존의 필요성에 대한 글](https://blog.hoseung.me/2023-03-23-how-to-transfer-date)을 작성하여 서버 개발자 전체가 즉시 확인할 수 있는 채널에 공유하여 설득하였습니다.
